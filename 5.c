...
static void on_display(void)
{
    ...
    GLfloat specular_coeffs[] = { 1, 0, 1, 1 };
	...
	glPushMatrix();
		glTranslatef(5, 0, 5);
        //diffuse_coeffs[0] = 0.698;
        //diffuse_coeffs[1] = 0.365;
        //diffuse_coeffs[2] = 0.365;
		glColor3f(0.278, 0.251, 0.251); //TODO:menjaj
		glScalef(10, 0, 10);
		glutSolidCube(1);
	glPopMatrix();
